...
public class AutomatorThreadPool implements Managed {

    private final Logger LOGGER = LoggerFactory.getLogger(AutomatorThreadPool.class);
    private ScheduledExecutorService executor;

    public AutomatorThreadPool(int numberOfThreads) {
